 ...
 */
export function decryptData(data, passphrase) {
 ...
 */
export function readAuthFile(filePath, passphrase) {
 ...
 */
export function writeAuthFile(filePath, content, passphrase) {
 ...
 */
export async function useEncryptedAuthState(authDir, passphrase) {
...
//# sourceMappingURL=EncryptedAuthStore.js.map