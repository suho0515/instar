...
export type MessageType = 'info' | 'sync' | 'alert' | 'request' | 'query' | 'response' | 'handoff' | 'wellness' | 'system';
 ...
 */
export type DeliveryPhase = 'created' | 'sent' | 'received' | 'queued' | 'delivered' | 'read' | 'expired' | 'dead-lettered' | 'failed';
 ...
 */
export declare const VALID_TRANSITIONS: ReadonlyArray<[DeliveryPhase, DeliveryPhase]>;
/**
 ...
 */
export declare const ALLOWED_INJECTION_PROCESSES: ReadonlyArray<string>;
...
export declare const DEFAULT_TTL: Record<MessageType, number>;
/** Default data retention per message type (in days) */
export declare const DEFAULT_RETENTION_DAYS: Record<MessageType, number>;
...
/** Thread limits */
export declare const THREAD_MAX_DEPTH = 50;
export declare const THREAD_STALE_MINUTES = 30;
/** Message body size limits */
export declare const MAX_BODY_SIZE = 4096;
export declare const MAX_PAYLOAD_SIZE = 16384;
export declare const MAX_SUBJECT_LENGTH = 200;
export declare const PAYLOAD_INLINE_THRESHOLD = 2048;
/** Clock skew tolerance per transport type (in milliseconds) */
export declare const CLOCK_SKEW_TOLERANCE: Record<string, number | null>;
